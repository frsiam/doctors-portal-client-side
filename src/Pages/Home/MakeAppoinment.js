...
const MakeAppoinment = () => {
    return (
        <section className='flex justify-center items-center mt-40 mb-5' style={{ background: `url(${appoinmentbg})` }}>
            <div className='flex-1 hidden lg:block'>
                {/* max-w-full lg:max-w-sm */}
                <img className='mt-[-300px]' src={doctor} alt="" />
            </div>
            {/* px-36 py-28 */}
            <div className='flex-1 lg:pl-7 lg:pr-32 lg:my-28'>
                <h3 className='text-xl text-primary font-bold mb-4'>Appoinment</h3>
                <h1 className='text-3xl text-white mb-4'>Make an Appoinment Today</h1>
